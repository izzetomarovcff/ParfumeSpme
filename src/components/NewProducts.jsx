...
function NewProducts() {
  ...
  return (
    <div id='newsection' className='pt-5'>
      <h1 className='px-3'>Yeni Parfümlər</h1>
      <p className='px-3'>Yeni məhsullarımızdan yararlanın</p>
      {productdata.length == 0 ? (<div className='mx-auto text-dark'>Yeni məhsullar mövcud deyil</div>) : (
